...
from rl_x.algorithms.airl_ppo.pytorch.policy import Policy
from rl_x.algorithms.airl_ppo.pytorch.critic import Critic
from rl_x.algorithms.airl_ppo.pytorch.data_utils import prepare_expert_data
from rl_x.algorithms.airl_ppo.pytorch.discriminator import Discriminator
...
class AIRL_PPO:
    ...
    def update(self, batch, learning_iteration_step):
        ...
        with torch.no_grad():
            ...
            corrected_reward = logits
            absorbing_reward = absorbing_logits
        with torch.no_grad():
