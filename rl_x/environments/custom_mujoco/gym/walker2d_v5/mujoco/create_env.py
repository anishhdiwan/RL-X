...
from rl_x.environments.custom_mujoco.gym.walker2d_v5.mujoco.environment import Walker2D
from rl_x.environments.custom_mujoco.gym.walker2d_v5.mujoco.general_properties import GeneralProperties
from rl_x.environments.custom_mujoco.gym.walker2d_v5.mujoco.wrappers import RLXInfo


def create_train_and_eval_env(config):
    make_env = lambda: Walker2D(render=config.environment.render, horizon=config.environment.horizon)
