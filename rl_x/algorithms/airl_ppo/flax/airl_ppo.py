...
from rl_x.algorithms.airl_ppo.flax.policy import get_policy
from rl_x.algorithms.airl_ppo.flax.critic import get_critic
from rl_x.algorithms.airl_ppo.flax.discriminator import get_discriminator
from rl_x.algorithms.airl_ppo.flax.data_utils import prepare_expert_data
...
class AIRL_PPO:
    def __init__(self, config, train_env, eval_env, run_path, writer):
        ...
        log_prob = jnp.zeros_like(jnp.zeros((1,), dtype=jnp.float32), dtype=jnp.float32)
        ...
        self.discriminator_state = TrainState.create(
            ...
            params=self.discriminator.init(discriminator_key, initial_observation, action, initial_observation, jnp.zeros((1,), dtype=jnp.float32), log_prob),
            tx=optax.chain(
                optax.clip_by_global_norm(self.max_grad_norm),
