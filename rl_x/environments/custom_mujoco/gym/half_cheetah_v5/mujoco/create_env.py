...
from rl_x.environments.custom_mujoco.gym.half_cheetah_v5.mujoco.environment import HalfCheetah
from rl_x.environments.custom_mujoco.gym.half_cheetah_v5.mujoco.general_properties import GeneralProperties
from rl_x.environments.custom_mujoco.gym.half_cheetah_v5.mujoco.wrappers import RLXInfo


def create_train_and_eval_env(config):
    make_env = lambda: HalfCheetah(render=config.environment.render, horizon=config.environment.horizon)
