...
from rl_x.environments.custom_mujoco.gym.humanoid_v5.mujoco.environment import Humanoid
from rl_x.environments.custom_mujoco.gym.humanoid_v5.mujoco.general_properties import GeneralProperties
from rl_x.environments.custom_mujoco.gym.humanoid_v5.mujoco.wrappers import RLXInfo


def create_train_and_eval_env(config):
    make_env = lambda: Humanoid(render=config.environment.render, horizon=config.environment.horizon)
