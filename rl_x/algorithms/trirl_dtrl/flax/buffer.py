...
class ParamsBuffer:
    ...
    def add(cls, params_buffer, params):
        ...
        def update_buffer(buffer, new):
            ...
            return jax.lax.cond(index < size, not_full_size, full_size, operand=None)

        params_updated = jax.tree.map(update_buffer, params_buffer.params, params)
...
class EtasBuffer:
    ...
    def add(cls, etas_buffer, etas):
        ...
        etas_updated   = jax.tree.map(update_buffer, etas_buffer.etas, etas)
